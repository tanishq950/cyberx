...
namespace CyberX\Models\Context;
...
class Session extends Base {
    ...
    protected function getDetails(array $accountIds, int $apiKey, int $timezoneOffset = 0): array {
        ...
        $params[':night_start'] = gmdate('H:i:s', \CyberX\Utils\Constants::get()->NIGHT_RANGE_SECONDS_START - $timezoneOffset);
        $params[':night_end'] = gmdate('H:i:s', \CyberX\Utils\Constants::get()->NIGHT_RANGE_SECONDS_END - $timezoneOffset);

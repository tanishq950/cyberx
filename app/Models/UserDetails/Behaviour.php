...
namespace CyberX\Models\UserDetails;

class Behaviour extends \CyberX\Models\BaseSql {
    ...
    public function getDayDetails(int $userId, array $dateRange, int $apiKey): array {
        $params = [
            ...
            ':failed_login'     => \CyberX\Utils\Constants::get()->ACCOUNT_LOGIN_FAIL_EVENT_TYPE_ID,
            ':success_login'    => \CyberX\Utils\Constants::get()->ACCOUNT_LOGIN_EVENT_TYPE_ID,
            ':password_reset'   => \CyberX\Utils\Constants::get()->ACCOUNT_PASSWORD_CHANGE_EVENT_TYPE_ID,
            ':seconds_day'      => \CyberX\Utils\Constants::get()->SECONDS_IN_DAY,
            ':night_time_end'   => \CyberX\Utils\Constants::get()->SECONDS_IN_HOUR * 5,
        ];

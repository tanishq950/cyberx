...
class Email extends \CyberX\Models\BaseSql implements \CyberX\Interfaces\FraudFlagUpdaterInterface {
    ...
    public function getEmailDetails(int $id, int $apiKey): array {
        ...
        \CyberX\Utils\Enrichment::calculateEmailReputation($results);

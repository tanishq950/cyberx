...
class Navigation extends \CyberX\Controllers\Admin\Base\Navigation {
    ...
    public function getTimeFrameTotal(): array {
        $ids        = \CyberX\Utils\Conversion::getArrayRequestParam('ids');
        $type       = \CyberX\Utils\Conversion::getStringRequestParam('type');
        $startDate  = \CyberX\Utils\Conversion::getStringRequestParam('startDate');
        $endDate    = \CyberX\Utils\Conversion::getStringRequestParam('endDate');
